...
const Header = () => {
  ...
  return (
    <header className=" fixed z-40 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary">
      {/* Desktop & Tabs*/}
            ...
            {isMenu && (
              ...
              >
                {user && user.email === "subendernath@gmail.com" && (
                  <Link to="createItem">
                    <p
                      className="flex items-center gap-3 px-4 py-2 hover:bg-slate-200 transition-all text-textColor text-base duration-100 ease-out cursor-pointer rounded-lg"
      ...
      <div className=" flex md:hidden h-full justify-between">
        ...
        >
          <MdShoppingBasket className=" text-textColor text-2xl cursor-pointer hover:text-headingColor duration-100 transition-all ease-in-out" />
          <div className=" absolute -top-1 -right-2 h-5 w-5 bg-cartNumBg rounded-full flex items-center justify-center">
            <p className=" text-xs text-white font-semibold">2</p>
          </div>
        </motion.div>
          ...
          {isMenu && (
            ...
            >
              ...
              <ul className="flex flex-col   gap-1 ml-auto">
                <Link to="/">
                  <li
                    className=" text-base cursor-pointer px-4 py-2 text-textColor hover:bg-slate-200 transition-all  hover:text-textColor hover:text-base duration-100 ease-out rounded-lg"
                    onClick={() => setIsMenu(false)}
                  >
                    Home
                  </li>
                ...
                <li
                  className="text-base px-4 py-2 cursor-pointer text-textColor hover:bg-slate-200 transition-all  hover:text-textColor hover:text-base duration-100 ease-out rounded-lg"
                  onClick={() => setIsMenu(false)}
                >
                  Menu
                </li>
                <li
                  className="px-4 py-2 text-base cursor-pointer text-textColor hover:bg-slate-200 transition-all  hover:text-textColor hover:text-base duration-100 ease-out rounded-lg"
                  onClick={() => setIsMenu(false)}
                >
                  About Us
                </li>
